					...
					<main className='main main_dice'>
						<div className='container mt-5'>
							...
							<div className='row show-boxs'>
								<div className='col-md-5 show-box'>
									<div className='row'>
									...
									<div className='col-md-6'>
										<div className='row' style={{paddingTop:"17px"}}>
											<div className='col-md-2'>
												<img src={bitcoin_img} alt="BTC" width="100px" loading="lazy" className="icon_ball"/>
											</div>									
											<div className='col-md-10'>
												<input className='temp_val' type='text' id="temp_val1"/>
												<h5 id="temp_val2" className='text-grey'>$0.0019075</h5>
											</div>
										</div>
									</div>
									<div className='col-md-3'>
									...
									<form data-v-8ed583e4>
										<div  className="form-group">
											...
											<div  className="form-group__row full">
												<input className="no_bets" onclick="this.select()" inputMode="decimal" placeholder="0" type="text" min="0" style={{width: "85% !important"}}/>
